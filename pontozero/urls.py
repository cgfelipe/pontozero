...
urlpatterns = [
    url(r'^api/estudante/cadastrar$', IControleEstudante.cadastrar, name='cadastrar_estudante'),


    url(r'^api/empresa/cadastrar$', IControleEmpresa.cadastrar, name='cadastrar_empresa'),
